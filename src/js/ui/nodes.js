...
export const displaySpeed = document.querySelector('.display-speed');
...
export const infoPanelClock = document.querySelector(' .clock-box');
export const infoPanelClockIcon = document.querySelector(' svg.lucide-clock-4')
export const infoPanelNoClockIcon = document.querySelector(' svg.lucide-alarm-clock-off')
export const delayBox = document.querySelector(' .delay-box');
// scene.js
export const gameWindow = document.getElementById('game-window');
export const displayPop = document.querySelector(' .display-pop');
export const displayDelay = document.querySelector(' .display-delay');
...
export const displayFunds = document.querySelector(' .display-funds');
export const displayDebt = document.querySelector(' .display-debt');
